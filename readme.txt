...
Большинство роутеров выполняют mtu fix ( -j TCPMSS --clamp-mss-to-pmtu  или  -j TCPMSS --set-mss ).
...
чексуммой не доходят вообще. Так что эта техника расчитана больше на прямые IP, работа за NAT - возможный, но
не гарантированный бонус. Как повезет.
